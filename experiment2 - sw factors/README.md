...
with a near-zero-mean guard (the OCF margin can turn negative); `revenue_stability`
...
| Factor | Definition | dir |
|---|---|---|
| `revenue_stability` | − trailing 36m std of YoY revenue growth | long high |
...
| Factor | α/mo | t(α) | combined Sharpe |
|---|---:|---:|---:|
| `revenue_stability` | +0.68% | **+3.45** | 1.82 |
...
- **The stability library is the strongest discovery.** All four second-moment
  factors carry significant industry-neutral alpha, and `revenue_stability` /
